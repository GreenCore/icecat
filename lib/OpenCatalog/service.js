...
openCatalog.prototype.getProduct = function(lang, GTIN) {
  const httpRequestUrl = this.getPath(lang) + ';ean_upc=' + GTIN;
...
openCatalog.prototype.getProductById = function(lang, productId) {
  const httpRequestUrl = this.getPath(lang) + ';product_id=' + productId;
...
openCatalog.prototype.getProductBySKU = function(lang, brand, sku) {
  const httpRequestUrl = this.getPath(lang) + ';prod_id=' + sku + ';vendor=' + brand;
